...
public class Exercise2 {
	...
	// Déclaration de la variable d'instance nommée mySecretNumber avec une valeur
	// initiale de 10
	...
	public void displaySecret() {
		...
		// La variable de référence secret pointe maintenant vers la variable d'instance
		// mySecretNumber

		System.out.println("Variable de référence accédant à la variable d'instance : " + secret);

		// Affichage de la valeur de la variable de référence (qui est la même que celle
		...
		// La variable de référence secret pointe maintenant vers la variable locale
		// (qui a la même valeur que la variable d'instance)

		System.out
				.println("Variable de référence accédant à la variable d'instance qui pointe vers la variable locale : "
						+ secret);
	...
	public static void main(String[] args) {
		...
		Exercise2 notSoPrivate = new Exercise2();
